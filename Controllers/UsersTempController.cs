...
namespace fitness.Controllers
{
    public class UsersTempController : Controller
    {
        ...
        public UsersTempController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: UsersTemp/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: UsersTemp/Create
